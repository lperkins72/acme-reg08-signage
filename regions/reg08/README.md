...
This folder is the region-default content layer for `reg08`.
...
- `regions/reg08/data/primary-assets.json`
- `regions/reg08/data/primary.json`
- `regions/reg08/data/footer.json`
- `regions/reg08/data/primaryending.json`
- `regions/reg08/assets/primary/manifest.json`
- `regions/reg08/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg08`.
